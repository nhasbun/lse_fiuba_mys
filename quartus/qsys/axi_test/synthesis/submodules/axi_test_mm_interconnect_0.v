...
`timescale 1 ps / 1 ps
module axi_test_mm_interconnect_0 (
		...
		input  wire        sw_pio_reset_reset_bridge_in_reset_reset,  //  sw_pio_reset_reset_bridge_in_reset.reset
	...
	wire  [112:0] sw_pio_s1_agent_rf_source_data;                           // sw_pio_s1_agent:rf_source_data -> sw_pio_s1_agent_rsp_fifo:in_data
	...
	wire  [112:0] sw_pio_s1_agent_rsp_fifo_out_data;                        // sw_pio_s1_agent_rsp_fifo:out_data -> sw_pio_s1_agent:rf_sink_data
	...
	wire  [111:0] sw_pio_s1_agent_rp_data;                                  // sw_pio_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [111:0] cmd_mux_001_src_data;                                     // cmd_mux_001:src_data -> sw_pio_s1_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                    // sw_pio_s1_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                  // cmd_mux_001:src_channel -> sw_pio_s1_burst_adapter:sink0_channel
	...
	wire  [111:0] sw_pio_s1_burst_adapter_source0_data;                     // sw_pio_s1_burst_adapter:source0_data -> sw_pio_s1_agent:cp_data
	wire          sw_pio_s1_burst_adapter_source0_ready;                    // sw_pio_s1_agent:cp_ready -> sw_pio_s1_burst_adapter:source0_ready
	wire    [1:0] sw_pio_s1_burst_adapter_source0_channel;                  // sw_pio_s1_burst_adapter:source0_channel -> sw_pio_s1_agent:cp_channel
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                            //                      clk.clk
		.reset                  (sw_pio_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_axi_master_ni #(
		...
		.aresetn                (~sw_pio_reset_reset_bridge_in_reset_reset),                //        clk_reset.reset_n
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (sw_pio_reset_reset_bridge_in_reset_reset),      //       clk_reset.reset
	...
	axi_test_mm_interconnect_0_router router (
	...
	axi_test_mm_interconnect_0_router router_001 (
	...
	axi_test_mm_interconnect_0_router_002 router_002 (
	...
	axi_test_mm_interconnect_0_router_002 router_003 (
	...
	altera_merlin_burst_adapter #(
		...
		.clk                   (clk_0_clk_clk),                                 //       cr0.clk
		.reset                 (sw_pio_reset_reset_bridge_in_reset_reset),      // cr0_reset.reset
	...
	axi_test_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                            //        clk.clk
		.reset              (sw_pio_reset_reset_bridge_in_reset_reset),                 //  clk_reset.reset
	...
	axi_test_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                            //        clk.clk
		.reset              (sw_pio_reset_reset_bridge_in_reset_reset),                 //  clk_reset.reset
	...
	axi_test_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                             //       clk.clk
		.reset               (led_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	axi_test_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                            //       clk.clk
		.reset               (sw_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	axi_test_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (led_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	axi_test_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                            //       clk.clk
		.reset              (sw_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	axi_test_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                            //       clk.clk
		.reset               (sw_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	axi_test_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                            //       clk.clk
		.reset               (sw_pio_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	axi_test_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	axi_test_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                            // in_clk_0.clk
		.in_rst_0_reset (sw_pio_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
